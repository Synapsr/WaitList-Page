...
INSERT INTO "new_Waitlist" ("backgroundColor", "collectCompany", "collectName", "countdownDate", "countdownEnabled", "createdAt", "customFields", "description", "headline", "id", "logoUrl", "primaryColor", "slug", "subheadline", "title", "updatedAt", "userId") SELECT "backgroundColor", "collectCompany", "collectName", "countdownDate", "countdownEnabled", "createdAt", "customFields", "description", "headline", "id", "logoUrl", "primaryColor", "slug", "subheadline", "title", "updatedAt", "userId" FROM "Waitlist";
DROP TABLE "Waitlist";
